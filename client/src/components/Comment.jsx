...
import { AdminBadge, Answer, BadgeArea, ChefBadge, CommentArea, CommentStyle, Deg, DegArea, Delete, FamousGourmetBadge, LikeButton, LocalBadge, ModBadge, PartnerBadge, Platform, ResponseArea, TravellerBadge, VedatMilorBadge, Writer } from './style/Comment.styled'
